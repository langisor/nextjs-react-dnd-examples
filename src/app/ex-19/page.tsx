      ...
      <CardContent className="text-lg style-text-muted-foreground">
        <div>
          ...
          <p>When the box is dragged, we remove its original DOM node by returning
            ...
            from <code className="language-text">render()</code> and let browser draw the
          ...
          <p>If we want to add custom logic such as snapping to grid or bounds
            ...
            Check out the <Link href="/react-dnd/examples/drag-around/custom-drag-layer">custom rendering example</a><br>
