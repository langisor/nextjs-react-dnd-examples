  ...
  return (
    <Card className="w-full max-w-2xl mx-auto my-4 p-4 text-sm text-muted-foreground">
      <CardTitle className="text-lg font-semibold mb-2">
        Ex 3: Notes about This example:
      </CardTitle>
      <CardContent className="text-lg style-text-muted-foreground">
        React DnD gives you the tools to be able to create sortable lists. To do
        this, make the same component both a drag source and a drop target, and
        reorder the data in the hover handler.
      </CardContent>
    </Card>
  );
}
